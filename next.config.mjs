...
const nextConfig = {
   ...
   * lại nạp `esm/_interop_require_default.js`. Hậu quả: `pnpm build` xanh,
   * image Docker build xong, nhưng container vừa khởi động là chết ngay với
   * MODULE_NOT_FOUND — lỗi chỉ lộ ra khi CHẠY THẬT, không lộ lúc build.
   *
